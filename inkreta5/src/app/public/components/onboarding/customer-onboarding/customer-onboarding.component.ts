...
import { AdditionalDetailsInitialValues } from '../vender-onboarding/Actions/AddtionalDetails.actions';
import { AttachmentTypeInitialValues } from '../vender-onboarding/Actions/AttachmentsType.actions';
import { GetCaptchanull } from './Actions/onboardCaptcha.actions';
import { SendOtpMailInitialValues } from '../vender-onboarding/Actions/SendMail.actions';
import { SendOtpMobileInitialValues } from '../vender-onboarding/Actions/SendMobile.actions';
@Component({
...
export class CustomerOnboardingComponent implements OnInit {
  ...
  constructor(private _store: Store,
    ...
    public _stdService: CustomerOnboardingService,
  ...
  update_form(saveddata:any){
    ...
    // //console.log(saveddata.verifiedmail)
    // //console.log(saveddata.verifiedphone)
...
save(){
  ...
  Additional_Details = this._myFB.group(
    ...
    companyWebsite: [''],
    msmeRegistered: [false, [Validators.required]],
