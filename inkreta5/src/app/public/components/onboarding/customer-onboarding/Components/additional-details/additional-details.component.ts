...
import { CustVerifydocumensComponent } from '../cust-verifydocumens/cust-verifydocumens.component';
...
export class AdditionalDetailsComponent implements OnInit {
  ...
  constructor(public OnboardService:OnboardService,private dialog:MatDialog,public _store:Store,public _Service:CustomerOnboardingService) {
    // setTimeout(()=>{
  ...
  open_doc(){ 
    const dialogRef = this.dialog.open(CustVerifydocumensComponent ,{disableClose: true});
