...
import { AttachmentType, AttachmentTypeInitialValues } from '../../Actions/AttachmentType.actions';
import { OnboardService } from '../../CustOnbardService'; 
import { attachementtypeState } from '../../Selectors/OnboardSelector.selector';

@Component({
  selector: 'app-cust-verifydocumens',
  templateUrl: './cust-verifydocumens.component.html',
  styleUrls: ['./cust-verifydocumens.component.css']
})
export class CustVerifydocumensComponent implements OnInit {
  ...
  loading: any;
  dropdown: any;
  constructor(private store:Store,private dialog:MatDialog,private service:OnboardService) { }
