...
@Component({
  selector: 'app-vender-activation',
  templateUrl: './vender-activation.component.html',
  styleUrls: ['./vender-activation.component.css']
  // styleUrls: ['../style1.css']
})
export class VenderActivationComponent implements OnInit {
  @Input()
  ...
  partnertype: any;
  constructor(private onboardservice:OnboardService,public _myFB:FormBuilder,private _store : Store<{save: {data : any}}>,private _http : HttpClient,public _Service:VenderOnboardingService ) { }
  ...
  submit(){
    //console.log(this.Additional_Details.value.isbusinesspartner)
