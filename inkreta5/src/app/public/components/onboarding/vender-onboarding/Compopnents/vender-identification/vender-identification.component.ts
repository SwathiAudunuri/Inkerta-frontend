...
@Component({
  selector: 'app-vender-identification',
  templateUrl: './vender-identification.component.html',
  styleUrls: ['./vender-identification.component.css']
  // styleUrls: ['../components1.css']
})
export class VenderIdentificationComponent implements OnInit {
  loading: any;
  ...
  service1: any;
  service2: any;
  constructor(public router:Router,private _store: Store, private _myFB: FormBuilder, private _http: HttpClient) { }
  ctx: any;
  @Input()
