...
@Component({
  selector: 'app-vender-mobile-dialog',
  templateUrl: './vender-mobile-dialog.component.html',
  styleUrls: ['./vender-mobile-dialog.component.css']
})
export class VenderMobileDialogComponent implements OnInit {
  otp:any;
  resstatus1: any;
  errormess: any="";
  loading: any;
  ...
  loading1: any;
  constructor(
    public dialogRef: MatDialogRef<VenderMobileDialogComponent>,
    public _store : Store,
