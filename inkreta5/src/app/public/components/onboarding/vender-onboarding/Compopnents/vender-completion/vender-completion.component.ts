...
@Component({
  selector: 'app-vender-completion',
  templateUrl: './vender-completion.component.html',
  styleUrls: ['./vender-completion.component.css']
})
export class VenderCompletionComponent implements OnInit {
  @Input()
