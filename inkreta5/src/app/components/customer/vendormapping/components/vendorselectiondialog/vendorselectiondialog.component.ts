...
import { VendorDetailState } from '../../Reducers/vendormap.reducer';
import { getsupplierdetail } from '../../Selectors/vendormap.selector';
...
export class VendorselectiondialogComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private serviceProvider: VendorserviceService,private store :Store<VendorDetailState>) { }
