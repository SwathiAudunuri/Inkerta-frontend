...
import { getcustomerInvoiceListHistory, getcustomerInvoiceListHistoryInitialValues, getcustomerInvoiceListHistorySuccess } from '../Actions/invoicelisthistory.actions'; 
...
export function customerinvoiceListHistoryReducer(state:any, action:any) {
