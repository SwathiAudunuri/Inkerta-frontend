...
@Component({
  selector: 'app-postforpay-invoice-sidenav',
  templateUrl: './postforpay-invoice-sidenav.component.html',
  styleUrls: ['./postforpay-invoice-sidenav.component.css']
})
export class PostforpayInvoiceSidenavComponent implements OnInit {
