...
export class InvoiceDetailsSidenavComponent implements OnInit {
  ...
  ngOnChanges(){
    ...
    //   this.InvoiceNo = this.details.invoicenum
    //   this.Date = this.details.invoicedate
    //   this.VendorName = this.details.company_name
    //   this.Status = this.details.invoice_status
    //   this.DueDate = this.details.invoiceduedate
    //   this.Amount = this.details.total_invoice_value
    // }
  }
  closesidenav(){
