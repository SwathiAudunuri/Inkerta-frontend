...
@Component({
  selector: 'app-draft-invoice-sidenav',
  templateUrl: './draft-invoice-sidenav.component.html',
  styleUrls: ['./draft-invoice-sidenav.component.css']
})
export class DraftInvoiceSidenavComponent implements OnInit {
...
// @Input() tabs:any;
  ...
  openDialog(item: any) {
    ...
    if(item==='Submit'){
      const dialogRef = this.dialog.open(SubmitDialogComponent,{panelClass: 'custom-dialog-container',disableClose: true });
    }
  }
  forward(){
