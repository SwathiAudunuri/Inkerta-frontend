...
@Component({
  selector: 'app-approved-invoice-sidenav',
  templateUrl: './approved-invoice-sidenav.component.html',
  styleUrls: ['./approved-invoice-sidenav.component.css']
})
export class ApprovedInvoiceSidenavComponent implements OnInit {
  status1: any = "new"
