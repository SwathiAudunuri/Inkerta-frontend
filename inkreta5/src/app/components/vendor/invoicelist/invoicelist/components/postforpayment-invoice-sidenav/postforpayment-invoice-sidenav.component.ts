...
@Component({
  selector: 'app-postforpayment-invoice-sidenav',
  templateUrl: './postforpayment-invoice-sidenav.component.html',
  styleUrls: ['./postforpayment-invoice-sidenav.component.css']
})
export class PostforpaymentInvoiceSidenavComponent implements OnInit {
  status1: any = "new"
