...
@Component({
  selector: 'app-queryfileupload',
  templateUrl: './queryfileupload.component.html',
  styleUrls: ['./queryfileupload.component.css']
})
export class QueryfileuploadComponent implements OnInit {
  ...
  constructor(private dialog:MatDialog,
    ...
    public dialogRef: MatDialogRef<QueryfileuploadComponent>,
