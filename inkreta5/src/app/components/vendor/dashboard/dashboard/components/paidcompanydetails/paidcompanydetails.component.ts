...
@Component({
  selector: 'app-paidcompanydetails',
  templateUrl: './paidcompanydetails.component.html',
  styleUrls: ['./paidcompanydetails.component.css']
})
export class PaidcompanydetailsComponent implements OnInit {
