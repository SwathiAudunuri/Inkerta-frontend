import { Component, OnInit, OnChanges, ViewChild, ElementRef, Input, ViewEncapsulation, AfterViewInit, HostListener } from '@angular/core';
...
export class BarchartComponent implements OnInit {
  ...
  private initSvg() {
      if(window.innerWidth > 768) {
          this.width = window.innerWidth / 2 - 230;
      } else {
  ...
  private initAxis() {
      ...
      this.x.domain(this.data.map((d) => d.vendor));
      this.y.domain([0, this.yAxisMax]);
     // //console.log(this.y.domain([0, this.yAxisMax]))
  }
