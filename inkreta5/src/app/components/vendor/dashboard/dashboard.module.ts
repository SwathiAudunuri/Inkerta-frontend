...
import { Overduebartop10Component } from './dashboard/components/overduebartop10/overduebartop10.component';
import { MatProgressSpinnerModule } from '@angular/material/progress-spinner';
import { InvoiceHistoryComponent } from './dashboard/components/invoice-history/invoice-history.component';
import { CompanydetailsComponent } from './dashboard/components/companydetails/companydetails.component';
import { CompanydetailstableComponent } from './dashboard/components/companydetailstable/companydetailstable.component';
import { TotalcompaniesComponent } from './dashboard/components/totalcompanies/totalcompanies.component';
import { MatSortModule } from '@angular/material/sort';
import { ActivityComponent } from './dashboard/components/activity/activity.component';
import { NgxSpinnerModule } from 'ngx-spinner';
import { TotalcompaniesbypaidinvoicesComponent } from './dashboard/components/totalcompaniesbypaidinvoices/totalcompaniesbypaidinvoices.component';
import { PaidcompanydetailsComponent } from './dashboard/components/paidcompanydetails/paidcompanydetails.component';
import { ClosedinvsofcompanytableComponent } from './dashboard/components/closedinvsofcompanytable/closedinvsofcompanytable.component';
...
@NgModule({
  declarations: [
    ...
    Overduebartop10Component,
    InvoiceHistoryComponent,
    CompanydetailsComponent,
    CompanydetailstableComponent,
    TotalcompaniesComponent,
     ActivityComponent,
     TotalcompaniesbypaidinvoicesComponent,
     PaidcompanydetailsComponent,
     ClosedinvsofcompanytableComponent
