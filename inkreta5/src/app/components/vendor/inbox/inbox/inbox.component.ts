...
import { getInvoiceListDetails } from '../../invoicelist/Actions/invoicelistdetails.actions';
import { getInvoiceListHistory } from '../../invoicelist/Actions/invoicelisthistory.actions';
...
export class InboxComponent implements OnInit {
  ...
  search1:any
  ngOnInit() {
    this.store.dispatch(getInvoiceListDetails({doc_refid : "I210323000346"}))
    // this.store.dispatch(getInvoiceListHistory({doc_refid : "I210323000346"}))
  }
  ngDoCheck(){
  ...
  invoke_invoice(value:any){
    ...
    this.store.dispatch(getInvoiceListDetails({doc_refid : this.doc_ref_id}))
    // this.store.dispatch(getInvoiceListHistory({doc_refid : this.doc_ref_id}))
  }
