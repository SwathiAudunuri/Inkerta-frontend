...
const feeds = [
  ...
  {
    "id":2,
    "Details": "The remit-to information is missing or incomplete for the Invoice #45678.You are requested to provide remit-to information and resubmit the invoice",
    "entity": "Query",
    "Date":"06-05-2021",
    "Routing_component":"Invoice.js",
    "actions":[
